    ...
    <div id="select">
      ...
      >
        <li>
          ...
          <a style={{display: "inline", color: "whitesmoke"}} onClick={(e) => handleClick(e, "code")} href="#!">Update Existing</a>
        </li>
        <li>
          <i className="material-icons white-text left">devices</i>
          <a style={{display: "inline", color: "whitesmoke"}} onClick={(e) => handleClick(e, "devices")} href="#!">New Website</a>
        </li>
        <li>
          <i className="material-icons white-text left">help</i>
          <a style={{display: "inline", color: "whitesmoke"}} onClick={(e) => handleClick(e, "help")} href="#!">Question</a>
        </li>
        <li>
          <i className="material-icons white-text left">comment</i>
          <a style={{display: "inline", color: "whitesmoke"}} onClick={(e) => handleClick(e, "comment")} href="#!">Feedback</a>
        </li>
      </ul>
    </div>
  );
